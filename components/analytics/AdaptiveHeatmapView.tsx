    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-green-50 text-green-700 text-[11px] font-semibold border border-green-200">
          ...
          {green} topic{green !== 1 ? 's' : ''} Grade 6+ (B)
        </span>
      ...
      <div className="flex items-center gap-4 text-[11px] text-gray-400">
        <div className="flex items-center gap-1.5">
          <div className="w-7 h-5 rounded bg-green-100 border border-green-200 flex items-center justify-center text-[9px] font-bold text-green-700">6</div>
          Grade 6+ (B)
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-7 h-5 rounded bg-amber-100 border border-amber-200 flex items-center justify-center text-[9px] font-bold text-amber-700">5</div>
          Grade 4–5 (C/C+)
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-7 h-5 rounded bg-red-100 border border-red-200 flex items-center justify-center text-[9px] font-bold text-red-700">3</div>
          Grade 1–3
        </div>
        <div className="flex items-center gap-1.5">
