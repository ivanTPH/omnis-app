...
import { Sparkles, ShieldCheck, CheckCircle, ChevronRight, History, Pencil, X, Save } from 'lucide-react'
    ...
    <div className="space-y-4">
      ...
      {approved && plan.autoGenerated && (
        <div className="flex items-center gap-2 bg-green-50 border border-green-200 rounded-xl px-4 py-2 text-sm text-green-800">
          <CheckCircle size={14} /> EHCP approved and active
        </div>
      )}
      ...
      {sections && (
        <div className="border border-gray-200 rounded-xl overflow-hidden">
          ...
          >
            ...
            <ChevronRight size={14} className={`transition-transform ${sectionsOpen ? 'rotate-90' : ''}`} />
          </button>
