...
export async function POST(req: NextRequest) {
  ...
  const html = `
    ...
    <table style="border-collapse:collapse;width:100%;">
      <tr><td style="padding:8px;font-weight:600;color:#374151;">Name</td><td style="padding:8px;color:#111827;">${h(name)}</td></tr>
      <tr style="background:#f9fafb;"><td style="padding:8px;font-weight:600;color:#374151;">Organisation</td><td style="padding:8px;color:#111827;">${organisation ? h(organisation) : '—'}</td></tr>
      <tr><td style="padding:8px;font-weight:600;color:#374151;">Email</td><td style="padding:8px;color:#111827;"><a href="mailto:${h(email)}">${h(email)}</a></td></tr>
      ${message ? `<tr style="background:#f9fafb;"><td style="padding:8px;font-weight:600;color:#374151;vertical-align:top;">Message</td><td style="padding:8px;color:#111827;">${h(message)}</td></tr>` : ''}
    </table>
